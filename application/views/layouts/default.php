        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url() ?>index.php/tablero" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tablero Desarrollo de software</p>
                </a>
              </li>
            </ul>
          </li>
          <!-- otro item -->
          <li class="nav-item">
            <a href="<?= base_url() ?>index.php/proyectos" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                Proyectos
                <!-- <i class="fas fa-angle-left right"></i>
          ...
          <!-- otro item -->
          <li class="nav-item">
            <a href="<?= base_url() ?>index.php/tareas" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                Tareas
                <!-- <i class="fas fa-angle-left right"></i> -->
